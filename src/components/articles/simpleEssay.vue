<template>
  <div class="simpleEssay">
      ...
      <!-- 具体内容 -->
      <div class="simpleEssay_content">
          <!-- 内容 -->
          <div class="simpleEssay_content_cont">
...
<script>
    ...
    import Articlesimple from '@/common/article/articlesimple'
    ...
    export default {
        ...
        mounted:function(){
            ...
            if(parseInt(scrollTop) > 1400){
                $('div.simpleEssay_content>.sidebar').css({
                    'position':'fixed',
                    'margin-left':0,
                    'top':'15px',
                    'right':'15px'
